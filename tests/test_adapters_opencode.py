from agent_handover.adapters.opencode import (
    BEGIN_MARKER,
    END_MARKER,
    EXAMPLE_HINT,
    agents_md_block,
...
def test_agents_md_block_points_at_opencode_example():
    assert EXAMPLE_HINT in agents_md_block()
    assert "examples/codex-cli" not in agents_md_block()
